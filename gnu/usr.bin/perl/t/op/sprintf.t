...
>%.2g<      >[]<          >0 MISSING<
>%.2gC<      >[]<          >0C MISSING<
>%.0g<      >-0.0<        >-0<		   >C99 standard mandates minus sign but C89 does not skip: MSWin32 VMS netbsd:vax-netbsd hpux:10.20 openbsd secbsd netbsd:1.5 irix darwin freebsd:4.9 android<
>%.0g<      >12345.6789<  >1e+04<
