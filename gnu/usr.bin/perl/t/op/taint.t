...

{
	...
	skip "opening |- is not stable on threaded Open/SecBSD/MirBSD with taint", 3
            if $Config{useithreads} and $Is_OpenBSD || $Is_SecBSD || $Is_MirBSD;
